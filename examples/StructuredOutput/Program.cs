...
public class StructuredOutputExamples
{
    ...
    public async Task BasicJsonSchemaExample()
    {
        ...
        var request = new LlmRequest
        {
            ...
            {
                Message.CreateText(MessageRole.System, "You are a product data generator. Always respond with valid JSON matching the provided schema."),
                Message.CreateText(MessageRole.User, "Generate a sample product for a tech store.")
            },
    ...
    public async Task DataExtractionExample()
    {
        ...
        var request = new LlmRequest
        {
            Messages = new List<Message>
            {
                Message.CreateText(MessageRole.System, "Extract structured information from the text according to the schema."),
                Message.CreateText(MessageRole.User, unstructuredText)
            },
            ResponseFormat = ResponseFormat.JsonSchema,
    ...
    public async Task ClassificationExample()
    {
        ...
        var request = new LlmRequest
        {
            Messages = new List<Message>
            {
                Message.CreateText(MessageRole.System, "Classify the customer feedback according to the schema."),
                Message.CreateText(MessageRole.User, customerFeedback)
            },
            ResponseFormat = ResponseFormat.JsonSchema,
    ...
    public async Task MultiStepPlanningExample()
    {
        ...
        var request = new LlmRequest
        {
            Messages = new List<Message>
            {
                Message.CreateText(MessageRole.System, "Create a detailed execution plan matching the schema."),
                Message.CreateText(MessageRole.User, task)
            },
            ResponseFormat = ResponseFormat.JsonSchema,
